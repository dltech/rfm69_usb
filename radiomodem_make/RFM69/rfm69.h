...
#define	BITRATE					19200				///< битрейт, бит/с
#define CARRIER_FREQ			868250000			///< несущая частота в Гц
#define	OUTPUT_POWER			13					///< выходная мощность в дБм (13 dBm max)

#define RX_BW					50					///< ширина полосы канального фильтра в кГц
#define RX_BW_AFC				50					///< ширина полосы фильтра в кГц при автоподстройке частот
...
// FSK parametres
#define DEVIATION				40000				///< частота девиации в Гц
#define RISE_FALL_TIME_FSK		10					///< время спада и нарастания сигнала при FSK модуляции в микросекундах (от 10 до 3400)
